...
def extract_all_captions(captions, model, device, batch_size=256, num_workers=2):
...
def extract_all_images(images, model, device, batch_size=64, num_workers=2):
    data = torch.utils.data.DataLoader(
...
def main():
    ...
    image_feats = extract_all_images(
        image_paths, model, device, batch_size=64, num_workers=2)
