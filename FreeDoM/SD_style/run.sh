python txt2img.py --prompt "a cat wearing glasses." --style_ref_img_path "/tudelft.net/staff-umbrella/StudentsCVlab/mgoyal/mpgd_pytorch/nonlinear/SD_style/style_images" --ddim_steps 100 --n_iter 1 --n_samples 1 --seed 2023 --H 512 --W 512 --scale 5.0
python txt2img.py --prompt "snail" "hippopotamus" "cheetah" "crocodile" "lobster" "octopus" --ddim_steps 100 --n_samples 3 --seed 2024 --H 512 --W 512 --rho 0.2
python txt2img.py --prompt "hippopotamus" --ddim_steps 100 --n_iter 2 --outdir outputs_testing --n_samples 3 --seed 2024 --H 512 --W 512 --rho 0.3
python txt2img.py --prompt "snail" --ddim_steps 100 --n_iter 1 --n_samples 3 --seed 2023 --H 512 --W 512 --scale 5.0
