...
def general():
    ...
    config.save_freq = 4
    config.resume_from = "/home/anujinho/PhD_GuidedDiff/AlignProp/logs/unique-disco-47/checkpoints/checkpoint_8"# "/home/anujinho/PhD_GuidedDiff/AlignProp/logs/crimson-music-9/checkpoints/checkpoint_5"
