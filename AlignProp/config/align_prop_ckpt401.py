...
def general():
    ...
    config.save_freq = 4
    config.resume_from = "/home/anujinho/PhD_GuidedDiff/AlignProp/logs/fluent-music-30/checkpoints/checkpoint_2"# "/home/anujinho/PhD_GuidedDiff/AlignProp/logs/crimson-music-9/checkpoints/checkpoint_7"
