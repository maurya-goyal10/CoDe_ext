...
def compute_score():
    ...
    if Path.exists(base_path.joinpath('perf_ccode_b1_hpscore.json')):
        with open(base_path.joinpath('perf_ccode_b1_hpscore.json'), 'r') as fp:
            perf = json.load(fp)
    ...
    d = ['code_grad4_b5_aesthetic_gs10']
